...
Route::middleware('auth')->group(function () {
    ...
    //dokter
        ...
        Route::post('/dokter/periksa/update/{id}', [DokterController::class, 'updatePeriksa'])->name('dokter.periksaUpdate'); 
        Route::put('/dokter/periksa/update/{id}', [DokterController::class, 'updatePeriksa2'])->name('dokter.periksaUpdate2'); 
